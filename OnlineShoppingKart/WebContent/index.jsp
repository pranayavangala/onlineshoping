<!--A Design by W3layouts
   ...
   -->
<!DOCTYPE html>
<%@page import="persistance.GetConnection"%>
			...
			<div class="container-fluid">
				<div class="hedder-up row">
					<div class="col-lg-3 col-md-3 logo-head">
						<h1>
							<a class="navbar-brand" href="index.jsp">Toys-Shop</a>
						</h1>
					</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav ">
						...
						<li class="nav-item"><a href="shop.jsp" class="nav-link">Shop
								Now</a></li>
						<li class="nav-item"><a href="registration.jsp"
								...
								<div class="least-w3layouts-text-gap">
									<div class="row">
										...
										<div class="col-md-8 col-sm-8 clients-says-w3layouts">
											<h4>baby doll</h4>
											<span class="mt-2">iam HAPPY</span>
										</div>
										<div class="mt-3 news-agile-text">
											<img src="images/a1.jpg" alt="" class="image-fluid">
											<p class="mt-3">
												<span class="fas fa-quote-left"></span> iam really happy with my toy.
												iam very imperssed with the quality of product.
												i named it as chocho.i love to play with my chochoo<span
