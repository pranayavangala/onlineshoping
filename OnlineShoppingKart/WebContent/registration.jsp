...
<body>
	...
	<section class="inner-pages py-5">
		<div class="container py-xl-5 py-sm-3">
			<h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Register
				Here</h3>
			<!-- forms -->
				...
				<form action="RegistrationServlet" method="post">
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputEmail4">User Name</label> <input type="text" name="username"
								class="form-control" id="username" placeholder="User Name">
						</div>
						<div class="form-group col-md-6">
							<label for="inputPassword4">Password</label> <input name="password"
						...
						<div class="form-group col-md-6">
							<label for="inputEmail4">Mobile</label> <input type="text" name="mobile"
			...
			<div class="container py-lg-5 py-md-5 py-sm-4 py-3">
				...
				<div class="icons mt-4 text-center">
					...
					<p class="my-3">velit sagittis vehicula. Duis posuere ex in
						...
						Duis posuere velit sagittis vehicula. Duis posuere</p>
				</div>
